...
def cmd_adapter(args):
    ...
    audit_event(
        ...
        control_command_used=decision_metadata.get('control_command_used', False),
        control_command_backend=decision_metadata.get('control_command_backend', ''),
        control_command_status=decision_metadata.get('control_command_status', ''),
        control_command_confidence=decision_metadata.get('control_command_confidence', 0.0),
        control_command_name=decision_metadata.get('control_command_name', ''),
        control_command_reason=decision_metadata.get('control_command_reason', ''),
        control_command_kb_posture=decision_metadata.get('control_command_kb_posture', ''),
        control_command_rejection_reason=decision_metadata.get('control_command_rejection_reason', ''),
        control_command_exception_detail=decision_metadata.get('control_command_exception_detail', ''),
        recovery_state_before=decision_metadata.get('recovery_state_before', ''),
        recovery_state_after=decision_metadata.get('recovery_state_after', ''),
        marginal_router_used=decision_metadata.get('marginal_router_used', False),
        marginal_router_backend=decision_metadata.get('marginal_router_backend', ''),
        marginal_router_status=decision_metadata.get('marginal_router_status', ''),
        marginal_router_confidence=decision_metadata.get('marginal_router_confidence', 0.0),
        marginal_router_result_route=decision_metadata.get('marginal_router_result_route', ''),
        marginal_router_result_topic=decision_metadata.get('marginal_router_result_topic', ''),
        marginal_router_result_goal=decision_metadata.get('marginal_router_result_goal', ''),
        marginal_router_repair_strategy=decision_metadata.get('marginal_router_repair_strategy', ''),
        marginal_router_fallback_used=decision_metadata.get('marginal_router_fallback_used', False),
        marginal_router_rejection_reason=decision_metadata.get('marginal_router_rejection_reason', ''),
        marginal_router_exception_detail=decision_metadata.get('marginal_router_exception_detail', ''),
