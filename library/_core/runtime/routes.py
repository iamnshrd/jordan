...
ROUTES: dict[str, dict] = {
    ...
    'relationship-maintenance': {
        'keywords': ['отношен', 'партнер', 'конфликт', 'жена', 'муж',
                     ...
                     'цепляем', 'друг друга', 'секс', 'сексуал',
                     'интим', 'близост', 'отверж', 'не дает', 'не даёт',
                     'не хочет меня', 'не хочет секса', 'желание',
                     'влечен', 'ревност', 'измен', 'desire', 'intimacy',
                     'sexual', 'sex', 'rejection', 'wife', 'husband',
                     'marriage', 'romance', 'betrayal'],
        'voice_bias': None,
    },
    'career-vocation': {
        'keywords': ['карьер', 'призвание', 'путь', 'работ', 'туман',
                     ...
                     'какой путь', 'мой путь', 'слишком многое', 'потерялся',
                     'потерялась', 'потерял смысл', 'запутался', 'запуталась'],
        'voice_bias': None,
    },
    'addiction-chaos': {
