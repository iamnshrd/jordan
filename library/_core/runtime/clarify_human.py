...
_PROFILE_SPECS = {
    ...
    'social-small-talk': {
        'opening': 'Если хочешь, не будем задерживаться на светской разминке.',
        'fallback_voice': (
            'Лучше быстро перейти к тому месту, где у тебя действительно есть вопрос, конфликт или узел.',
        ),
        'question_lead': 'Скажи прямо:',
        'question': 'что именно ты хочешь разобрать по существу?',
        'question_kind': 'topic_selection',
    },
    'how-to-address': {
        'opening': 'Можешь обращаться ко мне просто как к Джордану.',
        'fallback_voice': (
            'Но форму обращения лучше быстро оставить в стороне и перейти к самому вопросу.',
        ),
        'question_lead': 'Скажи прямо:',
    ...
    'problem-sharing-opening': {
        'opening': 'Тогда не начинай с общей рамки.',
        'fallback_voice': (
            'Если проблем несколько, выбери не самую красивую, а самую живую: ту, которая реально давит на тебя сейчас.',
        ),
        'question_lead': 'Скажи прямо:',
        'question': 'это прежде всего про отношения, страх, стыд, потерю направления или что-то ещё?',
        'question_kind': 'topic_selection',
    },
    'life-direction-opening': {
        'opening': 'Если вопрос звучит как «как мне дальше жить», значит расползаться уже начал не один эпизод, а сама жизненная ось.',
        'fallback_voice': (
            'Сначала нужно понять, что рушится первым: направление, дисциплина, связь с людьми или уважение к себе.',
        ),
        'question_lead': 'Скажи прямо:',
        'question': 'где у тебя сейчас главный распад — в цели, в порядке дня, в отношениях или в ощущении собственной ценности?',
        'question_kind': 'narrowing',
    },
    'appearance-self-presentation': {
        'opening': 'Если человек спрашивает, как стать красивее, вопрос почти никогда не сводится к косметике.',
        'fallback_voice': (
            'Обычно там перепутаны внешний вид, дисциплина, осанка, манера держаться и отношение к самому себе.',
        ),
        'question_lead': 'Скажи прямо:',
        'question': 'ты сейчас больше упираешься в тело, стиль, уверенность, запущенность или в то, как тебя читают люди?',
        'question_kind': 'narrowing',
    },
    'repair-misunderstanding': {
        'opening': 'Да, я сейчас пошёл слишком быстро и сделал ход менее ясным, чем нужно.',
        'fallback_voice': (
            'Давай не будем делать вид, будто ты уже должен понимать мою рамку с полуслова.',
        ),
        'question_lead': 'Скажу проще:',
        'question': 'ты хочешь продолжить про отношения, сменить тему или сначала коротко переформулировать, что именно тебе сейчас непонятно?',
        'question_kind': 'topic_selection',
    },
    'repair-meta-friction': {
        'opening': 'Справедливо.',
        'fallback_voice': (
            'Значит, я сейчас выбрал не тот ход для живого разговора, и это лучше признать сразу, чем продолжать давить в ту же сторону.',
        ),
        'question_lead': 'Сбросим и начнём заново короче:',
        'question': 'ты хочешь говорить об отношениях, о себе лично или просто назвать один узел без всякой рамки с моей стороны?',
        'question_kind': 'topic_selection',
    },
    'repair-wrong-level': {
        'opening': 'Хорошо, уберём лишнюю абстракцию.',
        'fallback_voice': (
            'Если уровень не тот, лучше сменить глубину разговора сейчас, чем продолжать строить красивую, но бесполезную схему.',
        ),
        'question_lead': 'Возьмём это проще:',
        'question': 'тебе сейчас нужен короткий человеческий перевод, один практический шаг или один точный вопрос, который сузит тему?',
        'question_kind': 'topic_selection',
    },
    'repair-wrong-topic': {
        'opening': 'Похоже, я зацепился не за тот слой проблемы.',
        'fallback_voice': (
            'Тогда не будем защищать старую интерпретацию, а лучше сразу перекинем разговор в правильный фокус.',
        ),
        'question_lead': 'Скажи коротко:',
        'question': 'это на самом деле про отношения, про внутреннее состояние, про дисциплину или вообще про другой узел?',
        'question_kind': 'topic_selection',
    },
    'vague-help-request': {
        'opening': 'Я могу предложить ход, но не хочу стрелять в пустоту.',
        'fallback_voice': (
            'Сначала нужно понять, что именно у тебя требует движения: решение, разговор, структура дня, отношения или внутренняя ясность.',
        ),
        'question_lead': 'Назови один слой:',
        'question': 'тебе сейчас важнее понять, что делать в отношениях, в работе, в собственной дисциплине или в состоянии, которое тебя разваливает?',
        'question_kind': 'narrowing',
    },
    'symptom-self-report': {
        'opening': 'Я не хочу отвечать тебе диагнозом на сыром человеческом сигнале.',
        'fallback_voice': (
            'Но и отмахиваться от этого не стоит: полезнее понять, какой паттерн ты реально переживаешь изнутри.',
        ),
        'question_lead': 'Скажи точнее:',
        'question': 'там сейчас главнее пустота, потеря интереса, усталость, тревожное сжатие или ощущение, что жизнь перестала звать тебя вперёд?',
        'question_kind': 'symptom_narrowing',
    },
    'scope-shift-meta': {
        'opening': 'Хорошо, значит ты хочешь вынести разговор из личного случая в более общую рамку.',
        'fallback_voice': (
            'Тогда удержим сам предмет разговора, но не будем путать абстракцию с потерей темы.',
        ),
        'question_lead': 'Скажи коротко:',
        'question': 'ты хочешь разбирать в общем виде отношения, внутренний распад, стыд, страх или какой-то другой узел?',
        'question_kind': 'topic_variant',
    },
    'broad-relationship-opening': {
        'opening': 'Если говорить об отношениях широко, не стоит начинать с самого болезненного сценария, будто всё уже почти развалилось.',
        'fallback_voice': (
            'Сначала полезнее понять, о каком слое связи вообще идёт речь: доверие, уважение, близость, конфликт или совместное удержание порядка.',
        ),
        'question_lead': 'Назови слой точнее:',
        'question': 'тебя сейчас больше интересует, что держит отношения, что их медленно разрушает, или как понять, где именно уже пошёл надлом?',
        'question_kind': 'pattern_family',
    },
    'teasing-opening': {
        'opening': 'Я не собираюсь играть в телепатию и делать вид, будто угадываю тебя без твоего участия.',
        'fallback_voice': (
            'Но можно оставить этот игровой заход и быстро перейти к реальному разговору без лишней сухости.',
        ),
        'question_lead': 'Скажи прямо:',
        'question': 'ты хочешь говорить об отношениях, о себе, о страхе, о стыде или о чём-то совсем другом?',
        'question_kind': 'topic_selection',
    },
