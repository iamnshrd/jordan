    ...
    DialogueFamilySpec(
        ...
        render_specs=(
            DialogueRenderSpec(
                goal='opening',
                clarify_type='scope',
                profile='teasing-opening',
                question_kind='topic_selection',
                reason_code='teasing-opening',
            ),
        ),
        opening_mode='topic_opening',
        opening_pending_slot='',
        allowed_transitions=('opening',),
        strong_markers=('угадай, что я хочу спросить', 'попробуй сам догадаться'),
        concept_markers=('угадай', 'догад'),
        subject_markers=('спросить',),
        threshold=2,
    ),
    DialogueFamilySpec(
    ...
    DialogueFamilySpec(
        ...
        render_specs=(
            DialogueRenderSpec(
                goal='clarify',
                clarify_type='scope',
                profile='repair-misunderstanding',
                question_kind='topic_selection',
                reason_code='repair-misunderstanding',
            ),
        ),
        opening_mode='topic_opening',
        opening_pending_slot='',
        allowed_transitions=('opening',),
        strong_markers=('я не понимаю о чём ты', 'объясни проще', 'ты сейчас не туда пошёл'),
        concept_markers=('не понимаю', 'проще'),
        subject_markers=('о чём', 'о чем', 'туда'),
        threshold=2,
    ),
    DialogueFamilySpec(
        ...
        render_specs=(
            DialogueRenderSpec(
                goal='clarify',
                clarify_type='scope',
                profile='repair-meta-friction',
                question_kind='topic_selection',
                reason_code='repair-meta-friction',
            ),
        ),
        opening_mode='topic_opening',
        opening_pending_slot='',
        allowed_transitions=('opening',),
        strong_markers=('так разговора не получится', 'ты меня не слышишь', 'это мимо'),
        concept_markers=('разговора', 'не получится', 'не слышишь'),
        subject_markers=('мимо',),
        threshold=2,
    ),
    DialogueFamilySpec(
        ...
        render_specs=(
            DialogueRenderSpec(
                goal='clarify',
                clarify_type='scope',
                profile='repair-wrong-level',
                question_kind='topic_selection',
                reason_code='repair-wrong-level',
            ),
        ),
        opening_mode='topic_opening',
        opening_pending_slot='',
        allowed_transitions=('opening',),
        strong_markers=('слишком абстрактно', 'слишком резко', 'без этих общих слов'),
        concept_markers=('слишком', 'абстрактно', 'резко'),
        subject_markers=('общих слов',),
        threshold=2,
    ),
    DialogueFamilySpec(
        ...
        render_specs=(
            DialogueRenderSpec(
                goal='clarify',
                clarify_type='scope',
                profile='repair-wrong-topic',
                question_kind='topic_selection',
                reason_code='repair-wrong-topic',
            ),
        ),
        opening_mode='topic_opening',
        opening_pending_slot='',
    ...
    DialogueFamilySpec(
        ...
        render_specs=(
            DialogueRenderSpec(
                goal='clarify',
                clarify_type='human_problem',
                profile='vague-help-request',
                question_kind='narrowing',
                reason_code='vague-help-request',
            ),
        ),
        opening_mode='human_problem_clarify',
        opening_pending_slot='narrowing_axis',
        allowed_transitions=('opening',),
        strong_markers=('предложи что делать', 'ну и что теперь', 'и как дальше'),
        concept_markers=('что делать', 'как дальше'),
        subject_markers=('теперь',),
        threshold=2,
    ),
    DialogueFamilySpec(
        topic='symptom-self-report',
        route='general',
        stance='personal',
        goal='clarify',
        render_specs=(
            DialogueRenderSpec(
                goal='clarify',
                clarify_type='human_problem',
                profile='symptom-self-report',
                question_kind='symptom_narrowing',
                reason_code='symptom-self-report',
            ),
        ),
        opening_mode='human_problem_clarify',
        ...
        concept_markers=('подозреваю', 'кажется', 'похоже'),
        subject_markers=('ангедон', 'тревог', 'выгор', 'депресс'),
        self_markers=('у меня', 'я ', 'мне '),
        threshold=2,
    ),
    DialogueFamilySpec(
        ...
        render_specs=(
            DialogueRenderSpec(
                goal='overview',
                clarify_type='scope',
                profile='scope-shift-meta',
                question_kind='topic_variant',
                reason_code='scope-shift-meta',
            ),
        ),
        opening_mode='followup_reframe',
        opening_pending_slot='topic_selection',
        allowed_transitions=('opening',),
        strong_markers=('я имею в виду в общем', 'а если абстрактно', 'не про меня'),
        concept_markers=('в общем', 'абстрактно'),
        subject_markers=('не про меня',),
        threshold=2,
    ),
    DialogueFamilySpec(
        ...
        render_specs=(
            DialogueRenderSpec(
                goal='opening',
                clarify_type='scope',
                profile='broad-relationship-opening',
                question_kind='pattern_family',
                reason_code='relationship-opening-broad',
            ),
        ),
        opening_mode='followup_reframe',
        opening_pending_slot='pattern_family',
        allowed_transitions=('opening',),
        strong_markers=('давай обсудим отношения', 'хочу поговорить про брак', 'что делает отношения крепкими', 'на чем держится брак', 'на чём держится брак'),
        concept_markers=('отношени', 'брак'),
        subject_markers=('крепк', 'держится', 'обсудим'),
        threshold=2,
    ),
    DialogueFamilySpec(
